...
<body class="bg-slate-100 text-black">
        <div id="spinner" class="fixed top-4 right-1/2 translate-x-1/2 duration-300 z-2 rounded-full bg-white p-2 border-2 border-black text-orange">
    ...
    <header class="text-orange-900 text-xl font-semibold text-center shadow-sm bg-orange flex justify-between items-center sticky top-0 left-0 right-0 border-b-3 border-b-black">
            <a href="{{ route('home') }}" class="border-r-2 border-r-black h-full p-3 hover:bg-white/30">
        ...
        <div>
            ...
            <a href="{{ route('sale.index') }}" class="border-l-2 border-l-black h-full p-3 hover:bg-white/30">
    ...
    <aside class="fixed left-0 right-0 bottom-0 flex flex-col starting:open:translate-y--10" id="notification"></aside>
