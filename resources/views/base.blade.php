...
<body class="bg-slate-100 text-slate-700">
    ...
    <header class="p-4 text-orange-900 text-xl font-semibold text-center shadow-sm bg-orange-400/80 flex justify-between sticky top-0 left-0 right-0 backdrop-blur-md">
        <div>
            <a href="{{ route('home') }}" class="size-8 rounded-sm flex items-center justify-center border border-orange-900/40">
        ...
        <div>
            <a href="{{ route('sale.index') }}" class="size-8 rounded-sm flex items-center justify-center border border-orange-900/40">
